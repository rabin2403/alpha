      ...
      >
        <div className="flex lg:flex-1 ">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Alpha Store Connect</span>
            {theme === "dark" ? (
              <Image
                className="w-[100px] h-full"
                src={logo}
                alt="Alpha Store Connect"
                width={50}
                height={20}
              />
            ) : (
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12 items-center">
          ...
          {theme === "light" ? (
            <SunIcon
              onClick={() => handleMode()}
              className="rounded-full hidden text-yellow-500 w-[30px] h-[30px]"
            />
          ) : (
            <MoonIcon
              onClick={() => handleMode()}
              className="rounded-full hidden text-primary w-[30px] h-[30px] "
            />
          )}
