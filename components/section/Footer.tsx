    ...
    <footer className=" body-font" id="footer">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          ...
          <Link href={"https://dashboard-wxko.onrender.com/"}>
      ...
      <div className="">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className=" text-sm text-center sm:text-left">
            © {new Date().getFullYear()} Developed By Alpha Store Sync —
            <a
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start opacity-0">
            <a
              className=""
