...
export const clients: clientsData[] = [
  {
    ...
    post: "Chief Manager",
    content:
      "Alpha checked all of the boxes. We were able to lockdown our devices to specific function only through the kiosk mode",
    image: user1,
  },
  {
    name: "Amelia Joseph",
    post: "Chief Manager",
    content:
      "It provided the required functionality that we were looking for. We could rapidly deploy new devices, we could push standard configurations on all our devices and we could maintain control",
    image: user2,
  },
  {
    name: "Jacob Joshua",
    post: "Chief Manager",
    content:
      'We were pleasantly surprised when we started using Hexnode. Its a phenomenal piece of software and we were able to take on very large clients that were looking for reliable UEM solution for their Samsung devices."',
    image: user3,
  },
  {
    name: "Jacob Joshua",
...
export const accordians: accordian[] = [
  {
    ...
    content:
      "My vision came alive effortlessly. Their blend of casual and professional approach made the process a breeze.",
  },
  {
